...
class Recipe:
    ...
    def calculate(self):
        ...
        for ingredient in self.ingredients:
            if ingredient.energy == 'None':
                ...
                ingredient.calculated_energy = int(ingredient.energy) * ingredient.weight / 100
                energy = energy + ingredient.calculated_energy
        self.energytotal = int(energy)
        self.energy = int(energy / self.weight * 100)
    ...
    def show(self):
        ...
        recipe_div.find('.js_energy').html(self.energy)
        recipe_div.find('.js_energytotal').html(self.energytotal)
        for ingredient in self.ingredients:
            ...
            ingredient_line.find('.recipe_ingredient_calculated_energy' ).html(ingredient.calculated_energy)
...
class Ingredient:
    def __init__(self, id, weight, energy): # quantity, unit, ratio,
        self.id = id
